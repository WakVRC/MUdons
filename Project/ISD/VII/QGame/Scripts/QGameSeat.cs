...
namespace Mascari4615
{
	public class QGameSeat : QuizSeat
	{
		...
		public override void UpdateStuff()
		{
			...
			{
				case QuizGameState.Wait:
				case QuizGameState.QuizTime:
				case QuizGameState.SelectAnswer:
					tile.material =
						HasSelectedAnswer ?
						tileSelectAnswerMaterial :
						tileAliveMaterial;
					break;
				case QuizGameState.ShowPlayerAnswer:
				case QuizGameState.CheckAnswer:
				case QuizGameState.Scoring:
